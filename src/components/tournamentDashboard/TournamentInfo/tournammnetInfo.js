            ...
            <div className="container p-2">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">A chess tournament is a series of chess games played competitively to determine a winning individual or team. Since the first international chess tournament in London, 1851, chess tournaments have become the standard form of chess competition among serious players.</p>
